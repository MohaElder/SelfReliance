...
{ "bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB" };
        ...
        private static int UnloadCounter;
        ...
        internal static bool HasBuildLogAvaliable()
        {
            ...
            try
            {
                ...
                while (!SR.EndOfStream && !String.IsNullOrEmpty(line = SR.ReadLine()))
                {
                    return true;
                }
                return false;
        ...
        internal static AssetHunterBuildReport AnalyzeBuildLog()
        {
            ...
            //DEBUG OTHER LOG
            //UnityEditorLogfile = Application.dataPath + "\\Resources\\Editor.Log";
            ...
            try
            {
                ...
                EditorUtility.DisplayProgressBar(
                                    "Parsing Log",
                                    "Reading Log file to find info on used assets",
                                    (float)linesRead / (float)SR.BaseStream.Length);
                ...
                while (!SR.EndOfStream && (line = SR.ReadLine()) != "")
                {
                    ...
                    buildReport.AddDependency(line.Substring(startIndex+1, stringLength - (startIndex+1)));
                }
        ...
        public static void UnloadUnused()
        {
            ...
            //Only unload assets once in a while, not necessary for each and every one
            if (UnloadCounter >= 20)
            {
                UnloadCounter = 0;
        ...
        public static long GetActualFileSize(string assetImportedPath)
        {
