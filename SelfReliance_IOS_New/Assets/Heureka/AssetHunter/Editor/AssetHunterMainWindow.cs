...
namespace HeurekaGames.AssetHunter
{
    public class AssetHunterMainWindow : EditorWindow, ISerializationCallbackReceiver
    {
        ...
        [UnityEditor.MenuItem("Window/Heureka/Asset Hunter _%h", priority = 20)]
        ...
        private void showDependenciesUI()
        {
            ...
            if (m_showAssemblyFoldout)
            {
                ...
                {
                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField(m_BuildLog.IncludedDependencies[i].AssemblyName, GUILayout.Width(400));
                    EditorGUILayout.LabelField(m_BuildLog.IncludedDependencies[i].sizeString);
                    EditorGUILayout.EndHorizontal();
                }
