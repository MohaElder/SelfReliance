                    ...
                    if (versionedSection.VersionData != null && versionedSection.VersionData.Count > 0)
                    {
                        ...
                        if (versionedSection.FoldOutVersionHistory)
                        {
                            for (int i = versionedSection.VersionData.Count() - 1; i >= 0; i--)
                            {
                                ...
                                //versionedSection.VersionData[i].FoldOut = EditorGUILayout.Foldout(versionedSection.VersionData[i].FoldOut, versionedSection.VersionData[i].VersionNum.GetVersionString());
                                //if (versionedSection.VersionData[i].FoldOut)
                                {
